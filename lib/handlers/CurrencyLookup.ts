...
import { ITokenListProvider, ITokenProvider, NATIVE_NAMES_BY_ID, nativeOnChain } from '@ququzone/smart-order-router'
...
export class CurrencyLookup {
  ...
  checkOnChain = async (tokenRaw: string): Promise<Token | undefined> => {
    ...
    // https://github.com/ququzone/smart-order-router/blob/71fac1905a32af369e30e9cbb52ea36e971ab279/src/providers/token-provider.ts#L23
    if (!isAddress(tokenRaw)) {
      return undefined
    }
